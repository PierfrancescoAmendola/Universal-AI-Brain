---
id: user-intent-infinite-context-persistence
label: Prevenzione Perdita Contesto per Saturazione Finestra Chat
hemisphere: LEFT
...
# Prevenzione Perdita Contesto per Saturazione Finestra Chat

> **Emisfero:** ⚡ Sinistro (Logic & Tech)  
> **Categoria:** `USER_INTENT` | **Piano:** 1 | **Padre:** [[domain-design-creativita]]

## 📝 Sintesi
Volontà utente: azzerare la perdita di contesto causata dalla saturazione delle finestre di contesto degli LLM, garantendo continuità cognitiva perenne tra chat diverse.
