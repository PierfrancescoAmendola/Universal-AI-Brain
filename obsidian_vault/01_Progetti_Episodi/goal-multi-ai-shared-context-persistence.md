---
id: goal-multi-ai-shared-context-persistence
label: Persistenza Totale del Contesto e dei Pensieri Multi-AI
hemisphere: LEFT
...
# Persistenza Totale del Contesto e dei Pensieri Multi-AI

> **Emisfero:** ⚡ Sinistro (Logic & Tech)  
> **Categoria:** `MENTAL_MODEL` | **Piano:** 1 | **Padre:** [[domain-design-creativita]]

## 📝 Sintesi
Principio fondante: preservare integralmente contesto, richieste e deduzioni di tutte le chat con qualsiasi AI affinché ogni modello condivida la memoria storica universale.
