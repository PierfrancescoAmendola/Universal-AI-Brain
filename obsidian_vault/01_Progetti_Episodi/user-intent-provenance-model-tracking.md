...
- [[episode-cross-model-memory-architecture]] (`BELONGS_TO_EPISODE`) — _Disegnato su Obsidian Canvas_
- [[episode-cross-model-memory-architecture]] (`CORPUS_CALLOSUM_LINK`) — _Disegnato su Obsidian Canvas_

## 📥 Connessioni Entranti (Backlinks)
- [[ai-reasoning-cross-model-provenance-validation]] (`VALIDATES`) — _Disegnato su Obsidian Canvas_
- [[domain-ai-cognitive-systems]] (`BELONGS_TO_DOMAIN`) — _Disegnato su Obsidian Canvas_
- [[episode-cross-model-memory-architecture]] (`CORPUS_CALLOSUM_LINK`) — _Disegnato su Obsidian Canvas_
- [[goal-multi-ai-shared-context-persistence]] (`COMPLEMENTS`) — _Disegnato su Obsidian Canvas_
