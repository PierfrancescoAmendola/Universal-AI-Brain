---
id: rule-zero-placeholder
label: Regola dell'Esecuzione Integrale (Zero Placeholder)
hemisphere: LEFT
...
# Regola dell'Esecuzione Integrale (Zero Placeholder)

> **Emisfero:** ⚡ Sinistro (Logic & Tech)  
> **Categoria:** `COGNITIVE_RULE` | **Piano:** 1 | **Padre:** [[domain-design-creativita]]

## 📝 Sintesi
Divieto tassativo di codice troncato, finto o parziale; ogni soluzione deve essere autosufficiente ed eseguibile.
