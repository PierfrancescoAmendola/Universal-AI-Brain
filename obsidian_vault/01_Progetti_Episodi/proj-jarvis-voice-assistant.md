---
id: proj-jarvis-voice-assistant
label: "Progetto: JARVIS Personal AI Voice Assistant"
hemisphere: LEFT
...
# Progetto: JARVIS Personal AI Voice Assistant

> **Emisfero:** ⚡ Sinistro (Logic & Tech)  
> **Categoria:** `ARCHITECTURE` | **Piano:** 1 | **Padre:** [[domain-ai-cognitive-systems]]

## 📝 Sintesi
Assistente vocale AI continuo in tempo reale a costo zero, integrato con il connettoma SQLite WAL tramite MCP, wake word locale, STT Whisper ultra-rapido e sintesi vocale neurale.
