---
id: universal-ai-brain
label: Universal AI Brain (Cognitive System)
hemisphere: LEFT
...
# Universal AI Brain (Cognitive System)

> **Emisfero:** ⚡ Sinistro (Logic & Tech)  
> **Categoria:** `ARCHITECTURE` | **Piano:** 1 | **Padre:** [[domain-ai-cognitive-systems]]

## 📝 Sintesi
Sistema di memoria persistente a grafo bi-emisferico per agenti LLM (Claude, Gemini, ChatGPT) con costo operativo zero.

## 📋 Dettagli Strutturati
- **raw:** `version`: 1.1.0, `backend`: FastAPI, `storage`: SQLite WAL, `frontend`: 3D Force Graph WebGL, `cost`: 0€ Forever
...
- [[reasoning-che-ore-sono-3134]] (`OPTIMIZES`) — _Restored from history_
- [[reasoning-comando-prompt-copia-rapi-8585]] (`OPTIMIZES`) — _Restored from history_
- [[reasoning-diagnosi-discrepanza-deploy-render]] (`OPTIMIZES`) — _Restored from history_
- [[reasoning-diagnosi-retrieval-gemini-e-roadmap-potenziamento]] (`OPTIMIZES`) — _Restored from history_
- [[reasoning-ehi-jarvis-ehi-jarvis-mi-puoi-dire-3176]] (`OPTIMIZES`) — _Restored from history_
- [[reasoning-ho-bisogno-di-sapere-tutto-ci-che-2753]] (`OPTIMIZES`) — _Restored from history_
- [[reasoning-jarvis-ricordi-quali-sono-gli-emis-3117]] (`OPTIMIZES`) — _Restored from history_
- [[reasoning-occultamento-pulsanti-mob-9019]] (`OPTIMIZES`) — _Restored from history_
- [[reasoning-ottimizzazione-mobile-web-8880]] (`OPTIMIZES`) — _Restored from history_
...
- [[user-intent-update-readme-architecture]] (`TARGETS_PROJECT`) — _Riferito al progetto target_
