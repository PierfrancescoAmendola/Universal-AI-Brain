...
label: "Dominio: Ingegneria Software & Architetture"
hemisphere: LEFT
...
# Dominio: Ingegneria Software & Architetture

> **Emisfero:** ⚡ Sinistro (Logic & Tech)  
> **Categoria:** `ARCHITECTURE` | **Piano:** 0 | **Padre:** [[root]]

## 📝 Sintesi
Ingegneria del Software, Backend FastAPI, SQLite WAL, Web development, architetture distribuite e linguaggi di programmazione.

## 📋 Dettagli Strutturati
- **scope:** Software engineering, backend, web systems, databases, distributed architecture

## 🔗 Connessioni Uscenti
- [[3d-force-galaxy-view]] (`CONTAINS_MODULE`) — _Restored from history_
- [[ui-gauge-widget-alcolsafe]] (`CONTAINS_MODULE`) — _Restored from history_
...
- [[proj-napolilive]] (`BELONGS_TO_DOMAIN`) — _Restored from history_
- [[fastapi-python-stack]] (`BELONGS_TO_DOMAIN`) — _Restored from history_
- [[flutter-dart-ecosystem]] (`BELONGS_TO_DOMAIN`) — _Restored from history_
- [[proj-harmonyapp]] (`CONTAINS_MODULE`) — _Restored from history_
- [[proj-particlesimulator]] (`CONTAINS_MODULE`) — _Restored from history_
- [[proj-regexriddle]] (`CONTAINS_MODULE`) — _Restored from history_
- [[proj-tesi-busbra-cnr]] (`CONTAINS_MODULE`) — _Restored from history_
- [[proj-tombola-wifi]] (`CONTAINS_MODULE`) — _Restored from history_
- [[ai-memory-ingest-spec]] (`CONTAINS_MODULE`) — _Restored from history_
- [[feat-ai-json-importer]] (`CONTAINS_MODULE`) — _Restored from history_
- [[arch-sqlite-wal]] (`CONTAINS_MODULE`) — _Restored from history_
